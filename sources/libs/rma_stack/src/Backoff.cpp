...
namespace rma_stack
{
    Backoff::Backoff(const std::chrono::nanoseconds &t_minDelayNs, const std::chrono::nanoseconds &t_maxDelayNs)
    :
    m_maxDelayNs(t_maxDelayNs),
    m_limitDelayInt(0),
