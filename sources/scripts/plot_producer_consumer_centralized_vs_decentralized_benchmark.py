...
CENTRALIZED_LOGS_PATH = "../data/centralized/producer_consumer_0/"
DECENTRALIZED_LOGS_PATH = "../data/decentralized/producer_consumer_0/"
PLOT_PATH = "../data"
TOTAL_OPS = 15000
...
ax.plot(procs, ops[1], marker='x', linestyle=linestyle_tuple[2][1], color='blue', label='децентрализованный стек')
ax.grid()
